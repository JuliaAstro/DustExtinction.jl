...
This package implements different empirical dust measurements for use in astronomy. This package is written in pure Julia and is built with first-class support with [Unitful.jl](https://github.com/painterqubits/unitful.jl), [DynamicQuantities.jl](https://github.com/SymbolicML/DynamicQuantities.jl), and [Measurements.jl](https://github.com/juliaphysics/measurements.jl). Unit support is provided through lightweight package extensions that load automatically when `Unitful.jl` or `DynamicQuantities.jl` are present.
