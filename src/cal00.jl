...
Calculate the magnitudes for given wavelengths `wave` in Å. Wavelength support is 0.12 to 2.2 microns (error will be thrown if out of this range). Accepts selective extinction `r_v` parameter with default set to Milky Way average of 3.1.
