...
const g03lmc_obsdata_x = (
    0.455, 0.606, 0.800, 1.818, 2.273, 2.703,
    3.375, 3.625, 3.875, 4.125, 4.375, 4.625, 4.875, 5.125,
    5.375, 5.625, 5.875, 6.125, 6.375, 6.625, 6.875, 7.125,
    7.375, 7.625, 7.875, 8.125, 8.375
)
const g03lmc_obsdata_axav = (
    0.030, 0.186, 0.257, 1.000, 1.293, 1.518,
    1,786, 1.969, 2.149, 2.391, 2.771, 2.967, 2.846, 2.646,
    2.565, 2.566, 2.598, 2.607, 2.668, 2.787, 2.874, 2.983,
    3.118, 3.231, 3.374, 3.366, 3.467
)
...
const g03lmc_optnir_axav_y = (0.03, 0.186, 0.257, 1.00, 1.293, 1.518)
